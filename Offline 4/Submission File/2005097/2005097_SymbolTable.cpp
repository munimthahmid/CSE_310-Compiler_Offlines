...
#include "2005097_SymbolTable.h"
    ...
    void SymbolTable::enter()
    {
        ...
        ScopeTable *newScopeTable = new ScopeTable(currentScopeTable->getTableSize(),currentScopeTable,scopeCount);
    ...
    bool SymbolTable::insertSymbolInCurrentScope(string name,string type,bool isFunction,bool isA)
    {
        return currentScopeTable->insert(name,type,isFunction,isA);
    }
